...
//  this.dateString = "";
  ...
  {
    this.stringArray = logArray[i].split(" ");
    this.commitString = stringArray[0];

    this.dateString = this.stringArray.slice(2, 7);
    this.dateObj = new Date(dateString);

    this.stringArray = logArray[i].split("\"");

    this.gitLogArray.push(new GitLog(this.commitString, this.dateObj, this.stringArray[1]));
  }
  return this.gitLogArray;
}
//end your code
